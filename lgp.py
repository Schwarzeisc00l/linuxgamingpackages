...
if "pop" in distroname or "ubuntu" in distroname or "debian" in distroname or "linuxmint" in distroname or "elementary" in distroname:
...
if "arch" in distroname or "manjaro" in distroname or "artix" in distroname or "blackarch" in distroname or "endeavour" in distroname:
    print("Welcome to Schwarze's Package Installer Script.  It will install the packages for gaming. ")
